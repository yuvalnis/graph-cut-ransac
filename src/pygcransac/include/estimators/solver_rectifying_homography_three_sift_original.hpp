...
class RectifyingHomographyThreeSIFTSolverOriginal : public SolverEngine<ScaleBasedRectifyingHomography, 1>
{
public:
...
bool RectifyingHomographyThreeSIFTSolverOriginal::areAllPointsCollinear(
    const cv::Mat& data,
    const std::vector<size_t>& inliers
)
{
...
bool RectifyingHomographyThreeSIFTSolverOriginal::estimateMinimalModel(
    const cv::Mat& data,
    const std::vector<size_t>& inliers,
    std::vector<ScaleBasedRectifyingHomography>& models
) const
...
bool RectifyingHomographyThreeSIFTSolverOriginal::estimateNonMinimalModel(
    const cv::Mat &data,
    const std::vector<size_t>& inliers,
    std::vector<ScaleBasedRectifyingHomography> &models,
    const std::vector<double>& weights
...
bool RectifyingHomographyThreeSIFTSolverOriginal::estimateModel(
    const DataType& data, // The set of data points
    const InlierContainerType& inliers,
    std::vector<ScaleBasedRectifyingHomography>& models, // The estimated model parameters
...
double RectifyingHomographyThreeSIFTSolverOriginal::scaleResidual(
    double x, double y, double s, const ScaleBasedRectifyingHomography& model
)
{
...
double RectifyingHomographyThreeSIFTSolverOriginal::residual(
    size_t type, const cv::Mat& feature,
    const ScaleBasedRectifyingHomography& model
) const
{
    if (type != 0)
    {
        ...
        err_msg << "Invalid type argument in class method "
                << "RectifyingHomographyThreeSIFTSolverOriginal::residual. Expected 0, "
...
double RectifyingHomographyThreeSIFTSolverOriginal::squaredResidual(
    size_t type, const cv::Mat& feature,
    const ScaleBasedRectifyingHomography& model
) const
{
...
bool RectifyingHomographyThreeSIFTSolverOriginal::internalNormalizePoints(
    const cv::Mat& data,
    const std::vector<size_t>& inliers,
    cv::Mat& normalized_features,
    NormalizingTransform& normalizing_transform
...
bool RectifyingHomographyThreeSIFTSolverOriginal::normalizePoints(
